...
class Taliban {
	class AllUnits {
		...
		backpack[] = {"UK3CB_CW_SOV_O_EARLY_B_RIF", "UK3CB_B_Largepack_Des", "UK3CB_ION_B_B_RIF_DES_01", "UK3CB_B_Fieldpack", "UK3CB_B_Alice_Bedroll_K", "UK3CB_B_Alice_Bedroll_2_K"};
		headgear[] = {	
	...
	class Type {
		...
		class Soldier_F {
			...
			backpack[] = {"UK3CB_CW_SOV_O_EARLY_B_RIF", "UK3CB_B_Largepack_Des", "UK3CB_ION_B_B_RIF_DES_01", "UK3CB_B_Fieldpack", "UK3CB_B_Alice_Bedroll_K", ""};
			goggles = "fsob_Beard01_Dark";
		};
